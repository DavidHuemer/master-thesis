public class DartIncorrect {
    /**
     * Calculates the new score in a dart game after a throw. Remember, dart scores
     * start at 501 and go down to 0.
     *
    ...
    public static int calculateScore(int number, int region, int currentScore) {
        ...
        int throwScore = number * region * 2;
