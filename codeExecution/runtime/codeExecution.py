...
def execute_on_test_instance(test_instance, test_case: TestCase, consistency_test_case: ConsistencyTestCase):
    ...
    return execute_with_parameters(method_to_call, parameters_list)
